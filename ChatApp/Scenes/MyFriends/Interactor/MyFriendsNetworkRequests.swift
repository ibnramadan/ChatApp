//
//  MyFriendsNetworkRequests.swift
//  ChatApp
//
...
class MyFriendsRequestsImplementation: PaginationNetworkRequests {
    func loadElements<T>(type: T.Type, specificURL: String?, params: Parameters?, queryString: String?, customHeaders: [String : String]?, completionHandler: @escaping (AFResult<ResponseArrayPaginatable<T>?>) -> Void) where T : BaseMappable {
        ...
        let request = MyFriendsRouter.getUsers(specificURL: specificURL, params: params, queryString: queryString,customHeaders: customHeaders)
